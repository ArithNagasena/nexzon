...
const productDetails = {
  ...
  highlights: [
    ...
    { icon: Camera, label: "Camera", value: "200MP Quad + 12MP Selfie" },
    { icon: Battery, label: "Battery", value: "5000 mAh, 45W Super Fast" },
    { icon: Cpu, label: "Processor", value: "Snapdragon 8 Gen 3 for Galaxy" },
    { icon: Wifi, label: "Connectivity", value: "5G, Wi-Fi 7, BT 5.3" },
    { icon: HardDrive, label: "Storage", value: "Up to 1TB, 12GB RAM" },
  ],
  specs: [
    { group: "Display", rows: [
      ["Size", "6.8 inches"],
    ...
    { group: "Camera", rows: [
      ...
      ["Ultrawide", "12 MP, 120° field of view"],
      ["Telephoto", "10 MP (3x) + 50 MP (5x periscope)"],
      ["Front", "12 MP, f/2.2, dual pixel AF"],
    ]},
    { group: "Battery & Charging", rows: [
      ["Capacity", "5000 mAh"],
      ["Wired", "45W Super Fast Charging"],
      ["Wireless", "15W Fast Wireless Charging 2.0"],
    ]},
    { group: "In the Box", rows: [
      ["Contents", "Handset, USB-C cable, ejection pin, quick guide"],
      ["Warranty", "1-year manufacturer warranty (Sri Lanka)"],
    ]},
  ],
};
  ...
  items: [
    {
      ...
      rating: 5,
      date: "2 weeks ago",
      title: "Best Galaxy yet — camera is unreal",
      body: "Switched from the S22 Ultra and the difference is huge. 200MP shots are crisp, S Pen is buttery smooth, and the titanium frame feels properly premium. Cellexa delivered next day in Colombo.",
      verified: true,
    },
    {
      name: "Hasini R.",
      ...
      body: "Battery easily lasts a full day with heavy use. Galaxy AI translation is genuinely useful for work calls. Genuine Samsung box with proper warranty card — exactly as advertised.",
      verified: true,
    },
    {
      name: "Roshan M.",
      ...
      rating: 4,
      date: "1 month ago",
      title: "Premium feel, slightly heavy",
      body: "Display and performance are top-tier. Only minor gripe is the weight — noticeable in the pocket. Installment option made the purchase much easier.",
      verified: true,
    },
  ],
};

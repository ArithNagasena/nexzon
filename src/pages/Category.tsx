...
import phone1 from "@/assets/galaxy-s25-fe.png";
...
const catalog: (Product & { sub: string; storage: string; ram: string; color: string; screen: number; battery: number; fiveG: boolean })[] = [
  { id: "p1",  name: "Samsung Galaxy S25 FE",   brand: "Samsung",   price: 260299, oldPrice: 525000, rating: 4.9, reviews: 312, image: phone1, badge: { label: "New", tone: "primary" },     sub: "Flagship",  storage: "256GB", ram: "8GB",  color: "Titanium", screen: 6.7, battery: 4422, fiveG: true },

...
const Register = () => {
  ...
  useEffect(() => {
    document.title = "Create your account — Nexzon";
  }, []);

  const strength = useMemo(() => getStrength(password), [password]);
  const strengthLabel = ["Too short", "Weak", "Fair", "Good", "Strong"][strength];
  const strengthColor = ["bg-destructive", "bg-destructive", "bg-promo", "bg-primary", "bg-success"][strength];

  return (
    <AuthLayout
      eyebrow="Join Nexzon"
      title="Create your account"
      subtitle="Faster checkout, order tracking, warranty claims and member rewards."
      footer={
        <>

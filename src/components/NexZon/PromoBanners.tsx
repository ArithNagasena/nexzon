  ...
  <section className="bg-surface section-y">
    <div className="container-page">
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Link
          to="/shop"
          className="group relative col-span-1 min-h-[240px] sm:min-h-[300px] lg:min-h-[320px] overflow-hidden rounded-3xl lg:col-span-2"
        >
          <img
            src={megaSale}
            alt=""
          ...
          <div className="relative flex h-full max-w-md flex-col justify-center gap-2.5 p-6 sm:gap-3 sm:p-10">
            ...
            <h3 className="font-display text-xl font-extrabold leading-tight text-white sm:text-2xl lg:text-3xl">
        ...
        <Link to="/pre-orders" className="group relative min-h-[240px] sm:min-h-[300px] lg:min-h-[320px] overflow-hidden rounded-3xl">
          <img
            src={preorderPromo}
            alt=""
            aria-hidden
          ...
          <div className="relative flex h-full flex-col justify-end gap-2 p-6 sm:p-8">
            ...
            <p className="hidden text-sm text-white/80 sm:block">Pay a small deposit and skip the launch-day queue.</p>

...
const TimeBox = ({ value, label }: { value: number; label: string }) => (
  <div className="flex flex-col items-center">
    <span className="grid h-12 w-12 place-items-center rounded-xl bg-background/20 font-display text-xl font-extrabold tabular-nums text-white backdrop-blur sm:h-14 sm:w-14 sm:text-2xl">
      {pad(value)}
    </span>
...
const FlashDeals = () => {
  ...
  return (
    <section className="bg-gradient-deep py-14 sm:py-20">
      <div className="container-page">
        <div className="mb-8 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl font-extrabold text-white sm:text-4xl">Deal of the Day</h2>
